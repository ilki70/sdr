  ...
  return (
    <main className="space-y-6">
      ...
      <section className="grid gap-5 xl:grid-cols-[0.95fr_1.05fr]">
        <div className="space-y-5">
          <article className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                <h2 className="text-xl font-semibold">Catalogo de agentes</h2>
                <p className="mt-1 text-sm text-white/60">Selecione um agente para revisar a versao ativa e o historico.</p>
              </div>
          ...
          <article className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <h2 className="text-xl font-semibold">Criar novo atendente</h2>
        ...
        <div className="space-y-5">
          <article className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <h2 className="text-xl font-semibold">Versao ativa e historico</h2>
            {detail ? (
          ...
          <article className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <h2 className="text-xl font-semibold">Publicar nova versao</h2>
            <p className="mt-2 text-sm text-white/60">Use o prompt como unidade de iteracao rapida do agente.</p>
            <form className="mt-4 space-y-3" onSubmit={handlePublishVersion}>
              ...
              >
                {isPublishing ? "Publicando..." : "Criar versao publicada"}
              </button>
            </form>
          </article>
        </div>
